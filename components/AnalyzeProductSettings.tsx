...
export default function AnalyzeProductSettings({ groupId }: AnalyzeProductSettingsProps) {
  ...
  const handleSaveScope = () => {
    ...
    console.log('Saving scope:', { conditions, hospitalRatesConditions, payerRatesConditions });
        ...
        <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
          ...
          <div className="bg-[#f7f8f8] border border-[#e3e7ea] rounded-lg flex gap-4 items-start p-4 relative shrink-0 w-full">
            <div className="overflow-clip relative shrink-0 w-4 h-4">
              <svg className="w-4 h-4 text-[#121313]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0l2.122 4.122L18 6l-3.878 1.878L12 12l-2.122-4.122L6 6l3.878-1.878L12 0zm-6 18l2.122 4.122L12 24l-3.878-1.878L6 18zm12 0l-2.122 4.122L12 24l3.878-1.878L18 18z" />
              </svg>
            </div>
