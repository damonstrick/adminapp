...
export default function ProductEntitlement() {
  ...
  return (
    <div className="bg-white flex flex-col items-start relative rounded-lg w-full">
      ...
      {/* Analyze Section */}
      <div className="border-b border-[#e3e7ea] border-solid box-border flex flex-col gap-2 items-start px-0 pt-[24px] relative shrink-0 w-full" style={{ paddingBottom: analyzeOpen ? '24px' : '24px' }}>
        <div className="w-full flex items-center gap-2 h-6" style={{ marginBottom: analyzeOpen ? '16px' : '0px', paddingBottom: analyzeOpen ? '0px' : '24px' }}>
          <button
